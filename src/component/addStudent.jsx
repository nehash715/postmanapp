...
this.getProductData()
    ...
    handleChange=(e)=>{
       /*const {currentTarget:input}=e
        ...
        input.name==="students"?s1.product.students=this.updateCB(
           // input.checked,input.value,s1.product.students
       ...
       :s1.product[input.name]=input.value;
        //console.log(  s1.product.students)
        this.setState(s1)
   ...
   async postData(url,obj){
    ...
    async putData(url,obj){
        ...
        this.props.history.push("/studentCourse")
    }
    handleSubmit=(e)=>{
        e.preventDefault();
    const {courseId}=this.props.match.params
...
updateCB=(inpValue,checked,value,inpArr)=>{
    console.log(inpValue,'value=',value)
  //  inpArr=inpValue?inpValue.join(","):[];
 //let inpArr=[]
    if(checked) {
        inpArr.push(value)
        console.log(inpArr)
    ...
    render(){
let {name,code,description,students=[]}=this.state.product
...
console.log(students)
 ...
 return <div className="container">
   ...
   {this.makeCheckboxes(studentName,students, "students","Students")}
