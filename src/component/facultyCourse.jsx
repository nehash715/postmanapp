...
export default class FacultyCourse extends Component {
    state={
        data:[]
    }
...
edit=(courseId)=>{
  this.props.history.push(`/faculty/edit/${courseId}`)
}
...
{data.map((p)=>{
    ...
    <div className="col-2">{p.faculty.map((k)=>{
